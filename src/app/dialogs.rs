use gpui::{
    Anchor, AppContext as _, Context, Entity, Focusable as _, FontWeight, InteractiveElement as _,
    ...
    pub(crate) fn show_sftp_permissions_dialog(
        ...
        window.open_dialog(cx, move |dialog: Dialog, _window, _| {
            ...
            dialog
                ...
                .content(move |content, _, _| content.child(content_form.clone()))
        });
    }
