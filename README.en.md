...
- **Content highlight rules**: Built-in detection covers errors, runtime states, HTTP traffic, URLs, email addresses, IPv4/IPv6, MAC addresses, UUIDs, ISO timestamps, and file paths. Extend it with prioritized literal or regular-expression rules, text/background/bold/underline styles, and live preview; full-screen TUIs keep their native colors.
